          ...
          <Reveal direction="up">
            <div className="cta-section mt-20">
              ...
              <p className="text-white/80 font-light mb-8 max-w-md mx-auto">
                Chat with us directly on WhatsApp at <strong className="text-white">+91 83105 31309</strong>, or email us at <a href="mailto:yogsathi@gmail.com" className="underline font-mono text-emerald-400">yogsathi@gmail.com</a> (general) / <a href="mailto:hr@jcrm.in" className="underline font-mono text-emerald-400">hr@jcrm.in</a> (careers).
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="https://wa.me/918310531309" target="_blank" rel="noreferrer" className="px-8 py-3 bg-[#25D366] text-white uppercase tracking-widest text-sm hover:brightness-110 transition-all rounded-full shadow-sm inline-flex items-center justify-center gap-2 font-medium">
                ...
                <a href="mailto:yogsathi@gmail.com" className="px-8 py-3 bg-white/10 hover:bg-white/20 text-white uppercase tracking-widest text-sm transition-all rounded-full shadow-sm inline-flex items-center justify-center font-medium border border-white/20">
                  Email Us
                </a>
